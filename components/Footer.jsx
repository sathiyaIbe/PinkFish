    ...
    <div className="flex flex-col mt-11 ">
      <div className=" flex flex-col md:flex-row justify-between w-[90%] md:w-[80%] self-center  gap-11 ">
        ...
        <div className='flex gap-4 '>
            ...
            <div className=' browse_show flex justify-center'>
            <Link href="/Events">
        ...
        <div className="flex flex-col gap-5 md:items-start items-center ">
          ...
          <div className="flex  flex-col gap-6 md:gap-3">
            <a href='https://www.facebook.com/pinkfishfestival/' target="_blank" className="flex md:justify-between gap-2 text-white">
              <p className="icon_text order-2 md:order-1">Facebook</p>
            ...
            <a href='https://www.youtube.com/@Pinkfishfestival' target="_blank" className="flex md:justify-between gap-2  text-white">
            <p className="icon_text order-2 md:order-1 ">Youtube</p>
            ...
            <a href='https://www.instagram.com/pinkfishfestival/' target="_blank" className="flex md:justify-between gap-2  text-white">
              <p className="icon_text order-2 md:order-1">Instagram</p>
              <svg className="mt-1 ml-1 order-1 md-order-2" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href=' https://www.tiktok.com/@pinkfishfestival' target="_blank" className="flex md:justify-between  gap-2  text-white">
             
              <p className="icon_text text-center order-2 md:order-1">Tiktok</p>
