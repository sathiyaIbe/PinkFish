      ...
      <div className=" flex flex-col md:flex-row justify-between w-[90%] md:w-[80%] self-center  gap-11 ">
        ...
        <div className="flex flex-col gap-5 md:items-start items-center ">
          ...
          <div className="flex  flex-col gap-6 md:gap-3">
            <a href='https://www.facebook.com/pinkfishfestival/' target="_blank" className="flex justify-between gap-2 text-white">
            ...
            <a href='https://www.youtube.com/@Pinkfishfestival' target="_blank" className="flex justify-between gap-2  text-white">
            <p className="icon_text order-2 md:order-1 mr-2 md:mr-0">Youtube</p>
            ...
            <a href='https://www.instagram.com/pinkfishfestival/' target="_blank" className="flex justify-between gap-2  text-white">
            ...
            <a href=' https://www.tiktok.com/@pinkfishfestival' target="_blank" className="flex justify-between gap-2  text-white">
              <p className="icon_text order-2 md:order-1">Tiktok</p>
