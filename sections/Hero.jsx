...
const Hero = () => (
  <section className="hero_container flex mb:2 md:mb-11 ">
      <img src='/HEROIMG_Mob.png' className='md:hidden' />
    <div className='  header_container flex justify-center'>
      ...
      <h1 className="absolute banner_img_5  text-center py-6 hidden md:block text-white ">
        ...
        <h1 className='hero_heading pt-3 mb-5 md:mb-24  basis-3/4 '>LIL PUMP live in KL
        ...
        <a href='#Events' >
          <svg className='cursor-pointer pb-5 w-[44px] md:w-[157px]' width="157" height="157" viewBox="0 0 157 157" fill="none" xmlns="http://www.w3.org/2000/svg">
