  ...
  <section className="hero_container flex mb-2 md:mb-11 ">
    ...
    <div className='  header_container flex justify-center'>
      ...
      {/* <h1 className="absolute banner_img_5  text-center py-6 hidden md:block text-white ">
        ...
        <div className='md:basis-3/4 flex justify-center md:justify-start '>
        <h1 className='hero_heading pt-3 mb-5 md:mb-24 max-w-[72%] text-center md:text-start   '>we are  <span className='text-[#F33288]'>pinkfish live</span>
        ...
        <a href='#Events' >
          <svg className='cursor-pointer pb-5 w-[84px] md:w-[131.14px] h-[84px] md:h-[131.14px] mt-6'  viewBox="0 0 157 157" fill="none" xmlns="http://www.w3.org/2000/svg">
